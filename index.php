...
$faqs = [
    ...
    [
        ...
        "response" => [
            ...
            Generally, Google offers its consumer services through either of two companies:",
    ...
    <header>
        <ul>
            <?php foreach ($navLinks as $link) { ?>
                ...
                <li <?php if($link["isActive"]){echo "class='active'";} ?>><a href=<?php echo $link["linkUrl"]?>><?php echo $link["name"] ?></a></li>
    ...
    <main>
        <section class="faq">
            <?php foreach ($faqs as $faq) { ?>
                ...
                <?php foreach ($faq["response"] as $response) { ?>
